export const mockData = {
  ...
  'model': {
    ...
    'properties': {
      ...
      'eventlisteners': '{"eventListeners":[{"event":"ACTIVITY_COMPENSATE, ACTIVITY_COMPLETED","implementation":"33","className":"33","delegateExpression":"33","retrowEvent":false,"$$hashKey":"uiGrid-001R","fields":[],"events":[{"event":"ACTIVITY_COMPENSATE","$$hashKey":"object:509"},{"event":"ACTIVITY_COMPLETED","$$hashKey":"object:513"}],"rethrowEvent":false,"rethrowType":"message","messagename":"33333","entityType":"33"},{"event":"ACTIVITY_STARTED, ENGINE_CLOSED, HISTORIC_ACTIVITY_INSTANCE_CREATED","implementation":"8","className":"8","delegateExpression":"8","retrowEvent":false,"$$hashKey":"uiGrid-001X","fields":[],"events":[{"event":"ACTIVITY_STARTED","$$hashKey":"object:524"},{"event":"ENGINE_CLOSED","$$hashKey":"object:526"},{"event":"HISTORIC_ACTIVITY_INSTANCE_CREATED","$$hashKey":"object:531"}],"entityType":"8","rethrowEvent":false,"rethrowType":"globalSignal","signalname":"666"}]}',
      'signaldefinitions': '[{"id":"5","name":"5","scope":"global","$$hashKey":"uiGrid-000B"},{"id":"4","name":"4","scope":"processInstance","$$hashKey":"uiGrid-000J"}]',
      'messagedefinitions': '[{"id":"55","name":"55","$$hashKey":"uiGrid-000Z"}]',
