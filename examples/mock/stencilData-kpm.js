export const AA = {
  ...
  'stencils': [
...

    {
      ...
      'title': '盒子',
      'description': '流程盒子',
      'view': '<?xml version="1.0" encoding="UTF-8" standalone="no"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:oryx="http://www.b3mn.org/oryx" xmlns:xlink="http://www.w3.org/1999/xlink" width="132" height="75" version="1.0"><oryx:magnets><oryx:magnet oryx:cx="58" oryx:cy="1" oryx:anchors="top"/><oryx:magnet oryx:cx="114" oryx:cy="36" oryx:anchors="right"/><oryx:magnet oryx:cx="56" oryx:cy="71" oryx:anchors="bottom"/><oryx:magnet oryx:cx="3" oryx:cy="36" oryx:anchors="left"/><oryx:magnet oryx:cx="58" oryx:cy="36" oryx:default="yes"/></oryx:magnets><g pointer-events="fill" oryx:minimumSize="50 40"><defs><filter id="f1"><feGaussianBlur in="SourceGraphic" stdDeviation="7"/></filter></defs><rect id="bg_frame" oryx:resize="vertical horizontal" x="0" y="0" width="112" height="72" rx="0" ry="0" stroke="none" stroke-width="1" fill="none"/><rect oryx:anchors="vertical horizontal" x="3" y="8" width="112" height="72" stroke="none" stroke-width="0" fill="#C6CFD9" filter="url(#f1)"/><rect id="text_frame" oryx:anchors="bottom top right left" x="3" y="1" width="112" height="72" stroke="none" stroke-width="0" fill="#ffffff"/><line id="status-bar" oryx:resize="vertical horizontal" fill="#90BFF6" stroke="#90BFF6" x1="3" y1="1" x2="112" y2="1" stroke-width="8"/><text font-size="12" id="box_code" x="10" y="15" oryx:align="top left" stroke="#333333" oryx:fittoelem="text_frame"></text><text font-size="12" id="text_name" x="10" y="46" oryx:align="middle left" oryx:fittoelem="text_frame" stroke="#333333"></text></g></svg>\n',
      'icon': 'activity/list/type.user.png',
      'groups': [
        '盒子'
      ],
